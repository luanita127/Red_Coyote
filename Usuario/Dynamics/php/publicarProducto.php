    ...
    <div class="row">
      <div class="col-7" id="centrar">
        ...
        <div class="producto" id="centrar">
          <form id="form-producto">
            <div class="d-grid gap-2 col-5 mx-auto" id="nombre"><input type="text" class="form-control" id="placeholder"
                placeholder="Nombre del Producto" name="nombre" required></div>
            ...
            <div class="d-grid gap-2 col-10 mx-auto">
              ...
              <textarea class="form-control" id="Descripción" rows="3" name="descripcion" required
      ...
      <div class="col-5" id="centrar">
        ...
        <div class="horarios" id="centrar">
          ...
          <div class="d-grid gap-2 col-10 mx-auto">
            ...
            <map name="image-map">
              ...
              <area target="" id="PatioSextos" alt="Patio de Sextos" title="Patio de Sextos" href=""
                coords="168,139,187,169" shape="rect">
              <area target="" id="PatioCuartos" alt="Patio de Cuartos" title="Patio de Cuartos" href=""
                coords="136,92,157,121" shape="rect">
              <area target="" id="PatioQuintos" alt="Patio de Quintos" title="Patio de Quintos" href=""
                coords="106,43,125,70" shape="rect">
              ...
              <area target="" id="Vestidores" alt="Vestidores" title="Vestidores" href="" coords="375,53,356,25"
                shape="rect">
            </map>
          </div>
        ...
        <div class="contacto" id="centrar">
          ...
          <div class="texto">Recuerda que tus datos de contacto son los que registraste en <a href="../perfil...">tu
              perfil</a>.</div>
          <div id="celular">
            <div id="content">
