...
<?php
    ...
    else
    {
        // Datos del producto //
        $id = $_COOKIE["objeto"];
        $sql="SELECT NombreObjeto, Foto, Descripcion, Recompensa, Fecha, CelularUsuario, InstagramUsuario, ID_PuntosPrepa FROM objeto NATURAL JOIN puntosprepa WHERE ID_OBJETO=$id;"; //ASIGNAR ID_PRODUCTO con la vista de productos
