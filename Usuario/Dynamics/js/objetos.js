/*Desarrolador: Luana Alvarez
  Propósito: Este código es el que hace toda la magia, recibe mediante fetch la información enviada de objetosDB.php, es decir, recibe el arreglo con todos 
  ...
  asignado con el forEach), cookie que se recupera en objetoEspecifico.php para poder hacer el despliegue de ese unico producto; y a su vez lo redirecciona a la
...
window.addEventListener("load", (e)=>{
    ...
    }).then((datosJSON)=>
    {
        ...
        datosJSON.forEach(function(element)//despliega todos los divs con la info
        {
            ...
            const productos = document.getElementById("productos");//manda la cookie y redirige a un objeto especifico
            productos.addEventListener("click",(e)=>
            {
                let id = e.target.dataset.id;
                console.log(id)
                document.cookie = "objeto=" + id + ";max-age=3600;";
